...
train_all = np.concatenate((train_bert, meta_train[5]), axis=1)
test_all = np.concatenate((test_bert, meta_test[5]), axis=1)
valid_all = np.concatenate((valid_bert, meta_valid[5]), axis=1)
